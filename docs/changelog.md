...
- **Populated the reference pages from the manuscript exports:** the merged **glossary** (291 distinct terms), the **abbreviation index** (127 distinct), the complete **bibliography** (275 works / 398 citations, with BibTeX, RIS and CSV downloads), the **resource index** (21 corpora + 35 models and toolkits, with dataset spotlights), the **figure sources** (70 of 74 scripts, one folder per chapter), and the four **Chapter 14 templates** plus a reproducibility checklist.
