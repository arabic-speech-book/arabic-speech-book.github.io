...
كل مدوّنة ومقياس ونموذج وأداة ورد في الكتاب، في مكان واحد. هذه هي الصفحة التي يربط بها الناس، وأسرعها تقادمًا؛ آخر تحقّق: **2026-08-12**.

!!! danger "تحذير يصرّ عليه الكتاب"
    النموذج المُدرَّب **مكوّن غير مُختبَر** حتى تختبره، وقائمة اللغات **ليست** دليلًا على تغطية اللهجات.

## المدوّنات (Table 7.1)

| الاسم | الحجم | النوع | المجال | الوصول/الرخصة | الاستخدام | الفصل | آخر تحقّق |
|-------|------|------|--------|----------------|-----------|-------|-----------|
...
جداول الفصول الأخرى لا تحمل عمود رخصة، فتُترَك تلك الحقول فارغة بدل التخمين.

| الاسم | النوع | المجال | الاستخدام | الفصل |
|-------|------|--------|-----------|-------|
