...
كل مصطلح معرَّف عبر الفصول الأربعة عشر، مدموجًا في قائمة أبجدية واحدة قابلة للبحث — **293 مصطلحًا متمايزًا**، و337 تعريفًا. وحيثما عرّف فصلان مصطلحًا تعريفًا مختلفًا، حُفِظت الصياغتان، كلٌّ موسومة بفصلها. استخدم مربّع البحث أعلى الصفحة للانتقال إلى مصطلح.
